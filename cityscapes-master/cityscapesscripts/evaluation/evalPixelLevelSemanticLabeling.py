...
PRED_PATH='/opt/yzg_matlab_tool/Cityscape/citys_val_deep/'
###################################
...
#/opt/yzg_matlab_tool/Cityscape/cityscape_val_pred_adj_densenet
#/home/cv/yzg_tensorflow/Cityscapes/gtFine_trainvaltest/gtFine/val
def getPrediction( args, groundTruthFile ):
    ...
    args.predictionPath = PRED_PATH#rootPath
...
args.groundTruthSearch  = os.path.join(args.cityscapesPath, 'gtFine_trainvaltest', "gtFine" , "val" , "*", "*_gtFine_labelIds.png" )
...
def main():
    ...
    # however the no-argument way is prefered
        ...
        groundTruthImgList = glob.glob('/opt/Cityscapes/gtFine_trainvaltest/gtFine/val/*/*_gtFine_labelIds.png')#args.groundTruthSearch
