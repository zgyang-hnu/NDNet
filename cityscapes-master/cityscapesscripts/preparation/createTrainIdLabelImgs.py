...
def main():
    ...
    if 'CITYSCAPES_DATASET' in os.environ:
        ...
        cityscapesPath ='/home/cv/yzg_tensorflow/Cityscapes/gtFine_trainvaltest/' #os.path.join(os.path.dirname(os.path.realpath(__file__)),'..','..')#os.path.realpath(__file__)获取当前脚本运行的绝对路径
