#https://github.com/meetshah1995/pytorch-semseg/tree/master/ptsemseg/models
...
class icnet(nn.Module):
    ...
    def __init__(
        ...
        self.loss = nn.CrossEntropyLoss(reduction='mean', ignore_index=255)#multi_scale_cross_entropy2d
